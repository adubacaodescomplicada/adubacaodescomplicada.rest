...
import com.frazao.adubacaodescomplicada.dao.adubacaodescomplicada.GarantiaDAOFiltro;
...
public class GarantiaDAOFiltroImpl implements GarantiaDAOFiltro {
	...
	@Override
	public Collection<Garantia> filtrar(final GarantiaFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".garantia as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), Garantia.class);
		// if (StringUtils.isNotBlank(f.getCpfCnpj())) {
