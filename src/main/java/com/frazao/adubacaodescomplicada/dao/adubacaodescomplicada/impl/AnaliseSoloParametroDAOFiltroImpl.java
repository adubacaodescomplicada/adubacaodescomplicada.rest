...
import com.frazao.adubacaodescomplicada.dao.adubacaodescomplicada.AnaliseSoloParametroDAOFiltro;
...
public class AnaliseSoloParametroDAOFiltroImpl implements AnaliseSoloParametroDAOFiltro {
	...
	@Override
	public Collection<AnaliseSoloParametro> filtrar(AnaliseSoloParametroFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".analise_solo_parametro as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), AnaliseSoloParametro.class);
		// if (StringUtils.isNotBlank(f.getCpfCnpj())) {
