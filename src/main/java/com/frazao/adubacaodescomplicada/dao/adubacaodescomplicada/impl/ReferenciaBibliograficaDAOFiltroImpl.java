...
import com.frazao.adubacaodescomplicada.dao.adubacaodescomplicada.ReferenciaBibliograficaDAOFiltro;
...
public class ReferenciaBibliograficaDAOFiltroImpl implements ReferenciaBibliograficaDAOFiltro {
	...
	@Override
	public Collection<ReferenciaBibliografica> filtrar(final ReferenciaBibliograficaFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".referencia_bibliografica as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), ReferenciaBibliografica.class);
		// if (StringUtils.isNotBlank(f.getCpfCnpj())) {
