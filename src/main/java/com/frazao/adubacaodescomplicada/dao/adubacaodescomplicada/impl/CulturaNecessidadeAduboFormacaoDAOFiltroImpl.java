...
import com.frazao.adubacaodescomplicada.dao.adubacaodescomplicada.CulturaNecessidadeAduboFormacaoDAOFiltro;
...
public class CulturaNecessidadeAduboFormacaoDAOFiltroImpl implements CulturaNecessidadeAduboFormacaoDAOFiltro {
	...
	@Override
	public Collection<CulturaNecessidadeAduboFormacao> filtrar(CulturaNecessidadeAduboFormacaoFiltroDTO f) {

		StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   heroku_c7c45a906fc2b28.cultura_necessidade_adubo_formacao as em").append("\n");
		...
		Query query = entityManager.createNativeQuery(sql.toString(), CulturaNecessidadeAduboFormacao.class);
		// if (StringUtils.isNotBlank(f.getCpfCnpj())) {
